    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100)),
                ('category', models.CharField(choices=[('Web Development', 'web_dev'), ('Programming Languages', 'Languages'), ('database management', 'Database'), ('Cloud & DevOps', 'cloud_&_tools'), ('AI/ML Tools', 'AI_&_ML'), ('Others Skills', 'Others_skills')], max_length=25)),
